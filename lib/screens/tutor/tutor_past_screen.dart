...
// Screen for viewing tutor's past appointments

class TutorPastAppointmentsScreen extends StatefulWidget {
  const TutorPastAppointmentsScreen({Key? key}) : super(key: key);

  @override
  State<TutorPastAppointmentsScreen> createState() =>
      _TutorPastAppointmentsScreenState();
}

class _TutorPastAppointmentsScreenState
    extends State<TutorPastAppointmentsScreen> {
...
// Dialog prompt for viewing notes associated with an availability
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: SelectableText("Your notes:  ${availability.tutorNotes}\n"
          "Student notes: ${availability.studentNotes}"),
      actions: [
        TextButton(
